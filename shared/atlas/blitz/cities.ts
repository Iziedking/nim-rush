...
export const BLITZ_CITIES: readonly BlitzCityDefinition[] = [
  {
    ...
    lengthMeters: 1_700, roadWidth: 7.2, baseSpeedMps: 25.3,
  ...
  },
  {
    ...
    lengthMeters: 1_790, roadWidth: 6.6, baseSpeedMps: 25.1,
  ...
  },
  {
    ...
    lengthMeters: 1_940, roadWidth: 8.2, baseSpeedMps: 26.2,
